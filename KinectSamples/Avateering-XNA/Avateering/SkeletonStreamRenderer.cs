...
namespace Microsoft.Samples.Kinect.Avateering
{
    ...
    public class SkeletonStreamRenderer : Object2D
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (null == this.Chooser.Sensor || false == this.Chooser.Sensor.IsRunning || this.Chooser.Sensor.Status != KinectStatus.Connected || null == skeletonData || null == this.mapMethod || null == this.SharedSpriteBatch)
            {
                return;
            }
                ...
                switch (skeleton.TrackingState)
                {
                    case SkeletonTrackingState.Tracked:
                        ...
                        foreach (Joint j in skeleton.Joints)
                        {
                            ...
                            if (null != this.Chooser && (false == Chooser.SeatedMode || (true == Chooser.SeatedMode && j.JointType >= JointType.ShoulderCenter && j.JointType < JointType.HipLeft)))
                            {
